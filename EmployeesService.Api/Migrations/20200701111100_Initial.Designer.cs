...
namespace EmployeesService.Api.Migrations
{
    ...
    [Migration("20200701111100_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employees.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("Employees.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("Employees.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Employees.Shared.Employee", b =>
                {
                    b.HasOne("Employees.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Employees.Shared.JobCategory", "JobCategory")
                        .WithMany()
